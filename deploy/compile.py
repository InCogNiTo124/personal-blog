...
class RssBuilder():
    def __init__(self):
        ...
        self.root = ET.Element('rss', {'xmlns:dc': "http://purl.org/dc/elements/1.1/", 'xmlns:content': "http://purl.org/rss/1.0/modules/content/", 'xmlns:atom': "http://www.w3.org/2005/Atom", 'xmlns:cc': "http://creativecommons.org/ns#"})
        ...
        atom_link = ET.SubElement(self.channel, 'atom:link', {'href': "https://blog.msmetko.xyz/feed", 'rel': "self", 'type': "application/rss+xml"})
...
class Database():
    ...
    def insert_post(self, post: Post):
        ...
        post.id = self.db_con.execute('INSERT INTO posts (content, title, subtitle, date, show) VALUES (?, ?, ?, ?, ?)', (post.html, post.title, post.subtitle, post.date, post.show)).lastrowid
        self.db_con.executemany('INSERT INTO post_tags (post_id, tag_id) VALUES (?, ?)', ((post.id, tag_id) for tag_id in tag_id_list))
        return
